...
def load_one_iteration_token_level_multirnn_model_without_is_continue_without_character_experiment():
...
load_fn_dict = {
    ...
    'one_iteration_token_level_multirnn_model_using_common_error_without_iscontinue_without_character': load_one_iteration_token_level_multirnn_model_without_is_continue_without_character_experiment,
    'one_iteration_token_level_multirnn_model_using_common_error_without_iscontinue_in_train_data': load_one_iteration_token_level_multirnn_model_using_common_error_with_output_mask_without_is_continue_experiment
}