...
@util.disk_cache(basename='common_error_token_code_load_data_without_iscontinue_without_identifier_mask', directory=cache_data_path)
def load_data_common_error_token_level_without_iscontinue_without_identifier_mask(max_bug_number=1, min_bug_number=0):
    train, test, vaild = read_cpp_common_error_token_code_records_set()
...
@util.disk_cache(basename='common_error_token_code_load_data_without_iscontinue_without_identifier_mask_sample_5000', directory=cache_data_path)
def load_data_common_error_token_level__without_iscontinue__without_identifier_mask_sample(max_bug_number=1, min_bug_number=0):
    train, test, vaild = sample_on_common_error_token_code_records()
...
@util.disk_cache(basename='token_level_multirnn_on_fake_cpp_data_parse_xy_without_iscontinue_without_identifier_mask', directory=cache_data_path)
def parse_xy_without_iscontinue_without_identifier_mask(df, data_type:str, keyword_voc, char_voc, max_bug_number=1, min_bug_number=0, sort_fn=None):
