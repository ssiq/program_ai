...
from experiment.c_error_experiment.experiment_util_for_c import create_c_embedding, \
    load_c_code_data_common_error_token_level_without_iscontinue, \
    load_c_code_data_common_error_token_level_without_iscontinue_sample
...
if __name__ == '__main__':
    ...
    # res = load_c_code_data_common_error_token_level_without_iscontinue_sample(10, 1)
    # train, test, vaild = read_cpp_random_token_code_records_set()
    load_data_fn = load_c_code_data_common_error_token_level_without_iscontinue
    # load_data_fn = load_c_code_data_common_error_token_level_without_iscontinue_sample
    ...
    train_supervision = create_supervision_experiment(load_data_fn, load_data_param, experiment_name='c_final_iterative_model_using_common_error_without_iscontinue', batch_size=16, create_condition_fn=error_count_create_condition_fn, modify_condition=modify_condition)
