...
if __name__ == '__main__':
    ...
    train_supervision = create_supervision_experiment(load_data_fn, load_data_param, experiment_name='one_iteration_token_level_multirnn_model_using_common_error_without_iscontinue', batch_size=16, create_condition_fn=error_count_create_condition_fn, modify_condition=modify_condition)
