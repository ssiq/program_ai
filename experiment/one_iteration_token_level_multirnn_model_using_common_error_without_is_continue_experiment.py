...
from experiment.experiment_util import sample, create_embedding, error_count_create_condition_fn, \
    ...
    load_data_token_level_sample, load_data_common_error_token_level__without_iscontinue_sample, load_data_common_error_token_level_without_iscontinue, \
    no_condition_create_fn, load_data_common_error_token_level_without_iscontinue_without_identifier_mask, load_data_common_error_token_level__without_iscontinue__without_identifier_mask_sample
...
if __name__ == '__main__':
    ...
    load_data_fn = load_data_common_error_token_level_without_iscontinue_without_identifier_mask
    # train, test, vaild = sample_on_random_token_code_records()
    # load_data_fn = load_data_token_level_sample
    # load_data_fn = load_data_common_error_token_level__without_iscontinue__without_identifier_mask_sample
    ...
    train_supervision = create_supervision_experiment(load_data_fn, load_data_param, experiment_name='one_iteration_token_level_multirnn_model_using_common_error_without_iscontinue_without_identifier_mask', batch_size=16, create_condition_fn=error_count_create_condition_fn, modify_condition=modify_condition)
