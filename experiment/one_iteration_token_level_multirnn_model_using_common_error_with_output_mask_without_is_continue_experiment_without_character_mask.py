...
from experiment.experiment_util import sample, create_embedding, error_count_create_condition_fn, \
    parse_xy_with_identifier_mask, parse_xy_token_level, sample_on_random_token_code_records, load_data_common_error_token_level_without_iscontinue_without_character_embedding, \
    load_data_common_error_token_level__without_iscontinue_without_character_embedding_sample, no_condition_create_fn
from model.one_iteration_token_level_multirnn_model_with_output_mask_without_is_continue_without_character_embedding import TokenLevelMultiRnnModel
...
if __name__ == '__main__':
    ...
    load_data_fn = load_data_common_error_token_level_without_iscontinue_without_character_embedding
    # train, test, vaild = sample_on_random_token_code_records()
    # load_data_fn = load_data_token_level_sample
    # load_data_fn = load_data_common_error_token_level__without_iscontinue_without_character_embedding_sample
    ...
    train_supervision = create_supervision_experiment(load_data_fn, load_data_param, experiment_name='one_iteration_token_level_multirnn_model_using_common_error_without_iscontinue_without_character', batch_size=16, create_condition_fn=error_count_create_condition_fn, modify_condition=modify_condition)
    ...
    restore_param_generator = random_parameters_generator(random_param={ },
                                                  choice_param={ },
                                                  constant_param={"learning_rate": 0.000536082568864,
                                                                  "hidden_size": 100,
                                                                  'rnn_layer_number': 2,
                                                                  'output_layer_num': 2,
                                                                  'decay_steps': 1000,
